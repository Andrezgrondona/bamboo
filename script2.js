    ...
    const listadoMenu = [];
     ...
     /* BUSCADOR CON FILTRO */   
           /*  let busquedaCategoria = prompt("Ingrese la categoria que quiere ver: \n-comida  \n-bebida")
            const filtroCategoria = listadoMenu.filter(x => x.tipo == busquedaCategoria) */
      /* BUSCADOR  CON FILTRO*/ 
      ...
      comida.addEventListener('click', renderComida)
      bebida.addEventListener('click', renderBebida)

    function renderComida(){
        
            const filtroCategoria = listadoMenu.filter(x => x.tipo == 'comida')

            let catalogo = document.querySelector('.catalogo')

            /* ACTUALIZA LA PAGINA PARA CARGAR LAS CARDS */
                catalogo.innerHTML = '' 
            /* ACTUALIZA LA PAGINA PARA CARGAR LAS CARDS */

            for (const listado of filtroCategoria   /* listadoMenu */) {
    ...
    function renderBebida(){
            ...
            const filtroCategoria = listadoMenu.filter(x => x.tipo == 'bebida')
